                  ...
                  {contacts.length === 0 ? (
                    ...
                    <table className="w-full border-collapse">
                      <thead style={{ background: '#F8FBF9' }}>
                        <tr>
                          {['Name', 'Job Title', 'Email', 'Status'].map(h => (
                        ...
                        {contacts.map(c => {
                          ...
                          return (
                            <tr key={c.id} className="cursor-pointer group" style={{ borderBottom: '1px solid #F0F7F3' }} onClick={() => router.push(`/contacts/${c.id}`)}>
                              ...
                              <td className="px-5 py-3 text-sm" style={{ color: '#638070' }}>{c.email ?? '—'}</td>
                              <td className="px-5 py-3"><SBadge value={c.status} type="contact" /></td>
                            </tr>
                          )
                        })}
                      </tbody>
