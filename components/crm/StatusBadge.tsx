...
const COMPANY_STATUS_STYLES: Record<CompanyStatus, { bg: string; color: string; label: string }> = {
  ...
  prospect: { bg: 'rgba(139,92,246,0.12)', color: '#8B5CF6', label: 'Prospect' },
  partner: { bg: 'rgba(99,102,241,0.12)', color: '#6366F1', label: 'Partner' },
...
const CONTACT_STATUS_STYLES: Record<ContactStatus, { bg: string; color: string; label: string }> = {
  active: { bg: 'rgba(16,185,129,0.12)', color: '#10B981', label: 'Active' },
  inactive: { bg: 'rgba(90,90,112,0.2)', color: '#9090A8', label: 'Inactive' },
  lead: { bg: 'rgba(245,158,11,0.12)', color: '#F59E0B', label: 'Lead' },
  customer: { bg: 'rgba(99,102,241,0.12)', color: '#6366F1', label: 'Customer' },
}

const DEAL_STAGE_STYLES: Record<DealStage, { bg: string; color: string; label: string }> = {
  prospecting: { bg: 'rgba(90,90,112,0.2)', color: '#9090A8', label: 'Prospecting' },
  qualification: { bg: 'rgba(245,158,11,0.12)', color: '#F59E0B', label: 'Qualification' },
  proposal: { bg: 'rgba(99,102,241,0.12)', color: '#6366F1', label: 'Proposal' },
  negotiation: { bg: 'rgba(139,92,246,0.12)', color: '#8B5CF6', label: 'Negotiation' },
